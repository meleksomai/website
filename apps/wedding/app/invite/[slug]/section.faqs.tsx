...
const HotelReservation = () => (
  <Box>
    ...
    <Paragraph>
      ...
      information regarding hotel reservations. We have arranged special room
      rates for our guests at two beautiful hotels in the area: Dar Said and
      Maison Blue.
    </Paragraph>
    ...
    <Paragraph>
      To make a reservation at either hotel, we kindly ask that you contact them
      directly and specify that you are attending the wedding of Melek Somai and
      Imen Ben Abid. When making your reservation, please reference the pricing
      that we have arranged for our guests. We also suggest that you cc me on
      your reservation request so that I can assist you if needed and make sure
      that everything is in order. We encourage you to make your reservation as
      soon as possible to ensure availability and to take advantage of the
      special rates we have secured for our guests.
    </Paragraph>
    <Heading as="p" size="1" serif>
    ...
    <Paragraph css={{ py: "$1" }}>
      <NextLink href="mailto:hotel@darsaid.tn">
        Booking emai lby :<Text>Makram Abdel Moumen - hotel@darsaid.tn</Text>
      </NextLink>
    </Paragraph>
    ...
    <Paragraph css={{ py: "$2" }}>
      <Text variant="light">Option A</Text>
      Double Room with sea view (with swimming pool depending on availability)-
      800TND (approx. $260) per night.
    </Paragraph>
    <Paragraph css={{ py: "$1" }}>
